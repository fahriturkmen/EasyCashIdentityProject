...
namespace EasyCashIdentityProject.PresentationLayer.Controllers
{
    public class SendMoneyController : Controller
    {
        ...
        public async Task<IActionResult> Index(SendMoneyForCustomerAccountProcessDto sendMoneyForCustomerAccountProcessDto)
        {
            ...
            var senderAccountNumberID = context.CustomerAccounts.Where(x => x.AppUserID == user.Id).Where(y => y.Currency == "Türk Lirası").Select(
                z => z.CustomerAccountID).FirstOrDefault();
            ...
            _customerAccountProcessService.Service_Insert(values);
